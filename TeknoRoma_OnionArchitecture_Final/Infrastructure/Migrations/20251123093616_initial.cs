        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierTransactions_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountInTRY = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CashRegisterNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsCustomerIssue = table.Column<bool>(type: "bit", nullable: false),
                    CustomerId = table.Column<int>(type: "int", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TechnicalServices_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TechnicalServices_Employees_AssignedToEmployeeId",
                        column: x => x.AssignedToEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TechnicalServices_Employees_ReportedByEmployeeId",
                        column: x => x.ReportedByEmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TechnicalServices_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_StoreId_Name",
                table: "Departments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierTransactions_TransactionNumber",
                table: "SupplierTransactions",
                column: "TransactionNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_AssignedToEmployeeId",
                table: "TechnicalServices",
                column: "AssignedToEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_CustomerId",
                table: "TechnicalServices",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_ReportedByEmployeeId",
                table: "TechnicalServices",
                column: "ReportedByEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_ReportedDate",
                table: "TechnicalServices",
                column: "ReportedDate");

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_ServiceNumber",
                table: "TechnicalServices",
                column: "ServiceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_Status",
                table: "TechnicalServices",
                column: "Status");

            migrationBuilder.CreateIndex(
                name: "IX_TechnicalServices_StoreId",
                table: "TechnicalServices",
                column: "StoreId");
        }
